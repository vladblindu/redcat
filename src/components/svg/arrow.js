...
import {LG, rotationDirection} from '../../globals/constants'

const baseCss = ca('fill-current')

const Arrow = ({className, size, direction}) =>
    <svg
        className={baseCss(className, iconSize(size), ` ${rotationDirection[direction]}`)}
